<template>
  <a-layout style="position: absolute;
    ...
    <a-layout-header class="layout-header">
      ...
      <a-menu v-model="current" mode="horizontal" :defaultSelectedKeys="['contact']" :style="{ lineHeight: '50px', background: '#434648', color: '#fff', textAlign: 'left'}"
    ...
    <a-layout>
      <a-layout-sider style="background: #fff" :width="broken ? '100%' : 350" breakpoint="lg" collapsedWidth="0"
        :trigger="null" v-model="collapsed" @collapse="onCollapse" @breakpoint="onBreakpoint">
    ...
    data() {
      return {
        ...
        userName: localStorage.getItem("userData") &&
          JSON.parse(localStorage.getItem("userData")).user_name,
        collapsed: false,
        broken: false,
        current: ["contact"]
      };
